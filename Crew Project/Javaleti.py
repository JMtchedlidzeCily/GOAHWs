...
while balance > 0 and Quit == False:
        while Main_room == 0:
        ...
        if Main_room == 1:
                    ...
                    while Baccarat_bet > balance:
                        Baccarat_bet = int(input("issuficent balance. Make a valid bet."))
                ...
                while Craps_bet > balance:
                    Craps_bet = int(input("issuficent balance. Make a valid bet."))
                balance -= Craps_bet
            ...
            Slotmachine_bet = int(input("Make a Bet!"))
            while Slotmachine_bet > balance:
                Slotmachine_bet = int(input("issuficent balance. Make a valid bet."))
...
if balance <= 0:
    print("Come back with more money!")
     ...
     print("Have a great day! Come back and win some more cash soon!")